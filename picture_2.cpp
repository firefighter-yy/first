...
int main()
{
        Mat cap = imread("../images/picture_2.png");
    ...
    Mat green_mask;
    inRange(hsv, Scalar(35, 50, 50), Scalar(85, 255, 255), green_mask);         //设定绿色颜色阀值
    ...
    Mat kernel1=getStructuringElement(1,Size(13,13));
    ...
    for(size_t i=0;i<contours.size();i++){
        ...
        //使用最小外接园
        if(area>500&&area<3000&&circularity>0.4){
            Point2f center;
            float radius;
